...
| รหัส           | ความต้องการ |
| ------------- | ------------- |
| FR001  | ผู้ใช้สามารถเปิดระบบผ่านหน้าจอได้  |
| FR002  | ระบบต้องแสดงข้อความเมื่อเปิดเครื่องสำเร็จ  |
| FR003  | ผู้ใช้สามารถตั้งค่าความเร็วมอเตอร์ได้ |
| FR004  | ระบบต้องเปิดปั้มน้ำอัตโนมัติเมือถึงเวลา |
| FR005  | ระบบส่งอีเมลแจ้งเตือนเมื่อเกิดข้อผิดพลาด |


Non-Functional Requirements
| รหัส   | ความต้องการ                                       |
| ------ | ------------------------------------------------- |
| NFR001 | ระบบต้องตอบสนองภายในไม่เกิน 2 วินาที              |
| NFR002 | ระบบต้องสามารถทำงานต่อเนื่องได้ 24/7              |
| NFR003 | ระบบต้องสามารถแสดง Log การทำงานย้อนหลังได้ 30 วัน |
| NFR004 | ความปลอดภัยของข้อมูลต้องได้มาตรฐาน ISO/IEC 27001  |
